...
return function()
    ...
    gls.left[5] = {
        FileName = {
            provider = config.pato.statusline_show_file_path and "FilePath" or "FileName",
            condition = condition.buffer_not_empty and is_not_dashboard,
